...
layout (std140, binding = 31) uniform ubo {
...
void main() {
      ...
      scattering = vec4(mat3(luminance_from_radiance) * delta_rayleigh.rgb, (mat3(luminance_from_radiance) * delta_mie).r);
      //delta_mie = vec3(1.0, 0.0, 0.0);
